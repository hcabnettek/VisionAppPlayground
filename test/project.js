...
describe('Vision Project API', function(){
	...
	describe('when requesting a new resource with invalid request /project', function(){
	...
	describe('when requesting resource get all projects', function(){
		...
		it('should respond with 200', function(done){
			request(app).get('/project/?user=' + login.user).expect('Content-Type', /json/).expect(200).end(function(err, res){
	...
	describe('when updating an existing resource /project/:id', function(){
		...
		it('should respond with 204', function(done){
			request(app).put('/project/' + id).send(project).expect(204, done);
	...
	describe('when deleting an existing resource /project/:id', function(){
		...
		it('should respond with 204', function(done){
			request(app).del('/project/' + id).expect(204, done);
	...
	describe('when attempting to delete a missing resource /project/:id', function(){
